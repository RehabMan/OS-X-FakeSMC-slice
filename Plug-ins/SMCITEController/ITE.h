...
const UInt8 ITE_PORTS_COUNT = 2;
const UInt8 ITE_PORT[2] = { 0x2e, 0x4e };
...
/*UInt8 ITE_SMARTGUARDIAN_FORCE_PWM[5]			= { 0x15, 0x16, 0x17, 0x88, 0x89 };
...
UInt8 ITE_SMARTGUARDIAN_START_PWM[5]			= { 0x63, 0x6b, 0x73, 0x93, 0x9b };
...
protected:
	...
	void	Exit();
public:	
	UInt8 ITE_SMARTGUARDIAN_FORCE_PWM[5];
	//UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_OFF[5];
	//UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_START[5];
	//UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_FULL_ON[5];
	UInt8 ITE_SMARTGUARDIAN_START_PWM[5];
	//UInt8 ITE_SMARTGUARDIAN_CONTROL[5];
	//UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_FULL_OFF[5];
