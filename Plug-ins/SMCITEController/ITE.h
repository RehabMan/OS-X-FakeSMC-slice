...
const UInt8 ITE_SMARTGUARDIAN_FORCE_PWM[5]				= { 0x17, 0x16, 0x15, 0x88, 0x89 };
const UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_OFF[5]		= { 0x70, 0x68, 0x60, 0x90, 0x98 };
const UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_START[5]		= { 0x71, 0x69, 0x61, 0x91, 0x99 };
const UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_FULL_ON[5]	= { 0x72, 0x6a, 0x62, 0x92, 0x9a };
const UInt8 ITE_SMARTGUARDIAN_START_PWM[5]				= { 0x73, 0x6b, 0x63, 0x93, 0x9b };
const UInt8 ITE_SMARTGUARDIAN_CONTROL[5]				= { 0x74, 0x6c, 0x64, 0x94, 0x9c };
const UInt8 ITE_SMARTGUARDIAN_TEMPERATURE_FULL_OFF[5]	= { 0x75, 0x6d, 0x65, 0x95, 0x9d };
